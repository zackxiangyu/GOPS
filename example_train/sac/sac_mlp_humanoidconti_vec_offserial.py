...
#
#  Description: example for sac + humanoidconti + mlp + off_serial + vector_env
#  Update Date: 2024-05-29, zack: create example
...
if __name__ == "__main__":
    ...
    parser.add_argument("--max_iteration", type=int, default=600000)
