...
#
#  Description: example for dsac + carracingraw + cnn + offserial
#  Update Date: 2024-06-27, Zack: create example
import argparse
...
if __name__ == "__main__":
    ...
    parser.add_argument("--wandb_project_sup", type=str, default=None,
                        help="Supplementary information for wandb project")
