...
#
#  Description: example for sac + humanoidconti + mlp + off_async
#  Update Date: 2024-03-28, zack
...
if __name__ == "__main__":
    ...
    parser.add_argument("--max_iteration", type=int, default=6000000)
    parser.add_argument(
        "--ini_network_dir",
        type=str,
        default=None
    ...
    parser.add_argument("--config_path", type=str, default='/home/dodo/zack/GOPS/example_train/parallel/sac_halfcheetah/example.yaml', help="Path to config file")
