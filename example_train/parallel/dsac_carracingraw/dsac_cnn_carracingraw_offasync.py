...
#
#  Description: example for dsac + carracingraw + cnn + offasync
#  Update Date: 2024-07-11, Zack: create example
import os
import argparse
import json
import yaml
...
if __name__ == "__main__":
    ...
    parser.add_argument("--config_path", type=str, default='parallel/dsac_carracingraw/example.yaml', help="Path to config file")
